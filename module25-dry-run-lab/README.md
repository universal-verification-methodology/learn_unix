...
**Kind:** `lab` · Primary lab: `dry-run-lab` · **Planned (Coming soon on tools index — use Track A until it ships)**

[← Makefile basics](../module24-make-basics/README.md) · [Course README](../README.md) · [Log / failure triage →](../module26-log-triage/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`dry-run-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/dry-run-lab/index.html](http://127.0.0.1:8080/tools/dry-run-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/dry-run-lab/](https://universal-verification-methodology.github.io/learning/tools/dry-run-lab/)
...
| Slides / video | `media/module25/` (generate later) |
