...
**Kind:** `lab` · Primary lab: `workflow` · **Shipped**

[← Relative symlink pitfalls](../module22-link-relative/README.md) · [Course README](../README.md) · [Makefile basics →](../module24-make-basics/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`workflow`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/workflow/index.html](http://127.0.0.1:8080/tools/workflow/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/workflow/](https://universal-verification-methodology.github.io/learning/tools/workflow/)
