...
**Kind:** `lab` · Primary lab: `man-help-lab` · **Shipped**

[← Virtual filesystem terminal](../module01-vfs-terminal/README.md) · [Course README](../README.md) · [Absolute vs relative paths →](../module03-path-abs-rel/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`man-help-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/man-help-lab/index.html](http://127.0.0.1:8080/tools/man-help-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/man-help-lab/](https://universal-verification-methodology.github.io/learning/tools/man-help-lab/)
