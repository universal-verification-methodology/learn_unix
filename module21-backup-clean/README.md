...
**Kind:** `lab` · Primary lab: `backup-clean` · **Shipped**

[← tar vs zip](../module20-zip-vs-tar/README.md) · [Course README](../README.md) · [Relative symlink pitfalls →](../module22-link-relative/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`backup-clean`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/backup-clean/index.html](http://127.0.0.1:8080/tools/backup-clean/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/backup-clean/](https://universal-verification-methodology.github.io/learning/tools/backup-clean/)
...
| Slides / video | `media/module21/` (generate later) |
