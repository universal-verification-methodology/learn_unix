...
**Kind:** `lab` · Primary lab: `scripting` · **Shipped**

[← Alias & functions](../module15-alias-lab/README.md) · [Course README](../README.md) · [Exit status & && / || →](../module17-exit-status-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`scripting`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/scripting/index.html](http://127.0.0.1:8080/tools/scripting/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/scripting/](https://universal-verification-methodology.github.io/learning/tools/scripting/)
...
| Slides / video | `media/module16/` (generate later) |
