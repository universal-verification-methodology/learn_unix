...
**Kind:** `lab` · Primary lab: `permissions` · **Shipped**

[← realpath / readlink](../module06-realpath-resolve/README.md) · [Course README](../README.md) · [Dotfiles & config homes →](../module08-dotfiles-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`permissions`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/permissions/index.html](http://127.0.0.1:8080/tools/permissions/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/permissions/](https://universal-verification-methodology.github.io/learning/tools/permissions/)
