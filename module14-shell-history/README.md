...
**Kind:** `lab` · Primary lab: `shell-history` · **Shipped**

[← Here-doc / here-string](../module13-here-doc-lab/README.md) · [Course README](../README.md) · [Alias & functions →](../module15-alias-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`shell-history`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/shell-history/index.html](http://127.0.0.1:8080/tools/shell-history/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/shell-history/](https://universal-verification-methodology.github.io/learning/tools/shell-history/)
...
| Slides / video | `media/module14/` (generate later) |
