...
**Kind:** `lab` · Primary lab: `link-relative` · **Shipped**

[← Backup & clean-build](../module21-backup-clean/README.md) · [Course README](../README.md) · [Pre-push / Make / env checklist →](../module23-workflow/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`link-relative`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/link-relative/index.html](http://127.0.0.1:8080/tools/link-relative/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/link-relative/](https://universal-verification-methodology.github.io/learning/tools/link-relative/)
...
| Slides / video | `media/module22/` (generate later) |
