...
**Kind:** `lab` · Primary lab: `sort-uniq-cut` · **Shipped**

[← Pipes, redirection, xargs](../module11-pipes/README.md) · [Course README](../README.md) · [Here-doc / here-string →](../module13-here-doc-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`sort-uniq-cut`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/sort-uniq-cut/index.html](http://127.0.0.1:8080/tools/sort-uniq-cut/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/sort-uniq-cut/](https://universal-verification-methodology.github.io/learning/tools/sort-uniq-cut/)
