...
**Kind:** `lab` · Primary lab: `path-abs-rel` · **Shipped**

[← man / --help discoverability](../module02-man-help-lab/README.md) · [Course README](../README.md) · [Globs & wildcards →](../module04-wildcards-globs/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`path-abs-rel`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/path-abs-rel/index.html](http://127.0.0.1:8080/tools/path-abs-rel/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/path-abs-rel/](https://universal-verification-methodology.github.io/learning/tools/path-abs-rel/)
...
| Slides / video | `media/module03/` (generate later) |
