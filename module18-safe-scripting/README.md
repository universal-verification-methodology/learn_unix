...
**Kind:** `lab` · Primary lab: `safe-scripting` · **Shipped**

[← Exit status & && / ||](../module17-exit-status-lab/README.md) · [Course README](../README.md) · [Project layout, archives, sed & diff →](../module19-project-archives/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`safe-scripting`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/safe-scripting/index.html](http://127.0.0.1:8080/tools/safe-scripting/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/safe-scripting/](https://universal-verification-methodology.github.io/learning/tools/safe-scripting/)
...
| Slides / video | `media/module18/` (generate later) |
