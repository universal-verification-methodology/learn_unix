# Module 17: Exit status & && / ||

**Kind:** `lab` · Primary lab: `exit-status-lab` · **Shipped**

[← Script control flow](../module16-scripting/README.md) · [Course README](../README.md) · [Safe scripting →](../module18-safe-scripting/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`exit-status-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/exit-status-lab/index.html](http://127.0.0.1:8080/tools/exit-status-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/exit-status-lab/](https://universal-verification-methodology.github.io/learning/tools/exit-status-lab/)
...
| Slides / video | `media/module17/` (generate later) |
