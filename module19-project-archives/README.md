...
**Kind:** `lab` · Primary lab: `project-archives` · **Shipped**

[← Safe scripting](../module18-safe-scripting/README.md) · [Course README](../README.md) · [tar vs zip →](../module20-zip-vs-tar/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`project-archives`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/project-archives/index.html](http://127.0.0.1:8080/tools/project-archives/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/project-archives/](https://universal-verification-methodology.github.io/learning/tools/project-archives/)
...
| Slides / video | `media/module19/` (generate later) |
