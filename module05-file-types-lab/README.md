...
**Kind:** `lab` · Primary lab: `file-types-lab` · **Shipped**

[← Globs & wildcards](../module04-wildcards-globs/README.md) · [Course README](../README.md) · [realpath / readlink →](../module06-realpath-resolve/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`file-types-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/file-types-lab/index.html](http://127.0.0.1:8080/tools/file-types-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/file-types-lab/](https://universal-verification-methodology.github.io/learning/tools/file-types-lab/)
...
| Slides / video | `media/module05/` (generate later) |
