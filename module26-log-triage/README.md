...
**Kind:** `lab` · Primary lab: `log-triage` · **Planned (Coming soon on tools index — use Track A until it ships)**

[← Dry-run mindset](../module25-dry-run-lab/README.md) · [Course README](../README.md) · [.env literacy →](../module27-env-file-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`log-triage`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/log-triage/index.html](http://127.0.0.1:8080/tools/log-triage/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/log-triage/](https://universal-verification-methodology.github.io/learning/tools/log-triage/)
...
| Slides / video | `media/module26/` (generate later) |
