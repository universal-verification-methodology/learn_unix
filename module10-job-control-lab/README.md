...
**Kind:** `lab` · Primary lab: `job-control-lab` · **Shipped**

[← Process list & signals](../module09-ps-kill-lab/README.md) · [Course README](../README.md) · [Pipes, redirection, xargs →](../module11-pipes/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`job-control-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/job-control-lab/index.html](http://127.0.0.1:8080/tools/job-control-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/job-control-lab/](https://universal-verification-methodology.github.io/learning/tools/job-control-lab/)
...
| Slides / video | `media/module10/` (generate later) |
