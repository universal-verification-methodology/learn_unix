...
**Kind:** `lab` · Primary lab: `dotfiles-lab` · **Shipped**

[← Permissions, umask, PATH](../module07-permissions/README.md) · [Course README](../README.md) · [Process list & signals →](../module09-ps-kill-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`dotfiles-lab`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/dotfiles-lab/index.html](http://127.0.0.1:8080/tools/dotfiles-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/dotfiles-lab/](https://universal-verification-methodology.github.io/learning/tools/dotfiles-lab/)
...
| Slides / video | `media/module08/` (generate later) |
