...
**Kind:** `lab` · Primary lab: `pipes` · **Shipped**

[← Job control](../module10-job-control-lab/README.md) · [Course README](../README.md) · [sort / uniq / cut →](../module12-sort-uniq-cut/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`pipes`**, in the browser and/or on a real shell.
...
1. Local: [http://127.0.0.1:8080/tools/pipes/index.html](http://127.0.0.1:8080/tools/pipes/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/pipes/](https://universal-verification-methodology.github.io/learning/tools/pipes/)
