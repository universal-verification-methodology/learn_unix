...
- Print it with the print-working-directory command
- Change it with change-directory
- List what is here with the list command
...
- Hidden files start with a dot and may not show unless you ask for them
- And remember
